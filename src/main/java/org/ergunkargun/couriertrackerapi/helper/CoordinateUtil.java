...
public class CoordinateUtil {
    ...
    final double SEMI_MAJOR_AXIS_MT = 6378137;
    final double SEMI_MINOR_AXIS_MT = 6356752.314245;
    final double FLATTENING = 1 / 298.257223563;
    final double ERROR_TOLERANCE = 1e-12;

    //Distance Using Vincenty’s Formula
    public double distanceBetween(Coordinate coordinate1, Coordinate coordinate2) {
